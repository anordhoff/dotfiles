...
## Type: QssColor
c.colors.completion.match.fg = nord['nord9']
...
## for transparency.
## Type: QssColor
c.colors.hints.bg = nord['nord0']

## Font color for hint borders.
## Type: QssColor
c.hints.border = "1px solid " + nord['nord10']

## Font color for hints.
## Type: QssColor
c.colors.hints.fg = nord['nord4']

## Font color for the matched part of hints.
## Type: QssColor
c.colors.hints.match.fg = nord['nord9']
...
## Type: QtColor
c.colors.tabs.bar.bg = nord['tabs']

## Background color of unselected even tabs.
## Type: QtColor
c.colors.tabs.even.bg = nord['tabs']
...
## Type: QtColor
c.colors.tabs.indicator.start = nord['nord3']
...
## Type: QtColor
c.colors.tabs.odd.bg = nord['tabs']
...
## Type: QtColor
c.colors.tabs.pinned.even.bg = nord['tabs']
...
## Type: QtColor
c.colors.tabs.pinned.odd.bg = nord['tabs']
