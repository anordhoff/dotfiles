## Autogenerated config.py (v2.3.1)
##
...
c.content.proxy = 'http://chiproxy.kdc.capitalone.com:8099'
...
c.content.user_stylesheets = ['~/dotfiles/qutebrowser/overscroll.css']
...
c.fonts.default_family = ['SF Mono Regular']
...
## Type: Padding
c.tabs.padding = {'top': 0, 'bottom': 0, 'left': 0, 'right': 6}
...
## qutebrowser`.
## Type: Dict
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}', 'g': 'https://google.com/search?q={}', 'yt': 'https://youtube.com/results?search_query={}'}
...
# config.bind('<Ctrl-Shift-N>', 'completion-item-focus prev-category', mode='command')
# config.bind('<Ctrl-Tab>', 'completion-item-focus next-category', mode='command')
# config.bind('<Shift-Tab>', 'completion-item-focus prev', mode='command')
# config.bind('<Tab>', 'completion-item-focus next', mode='command')
# config.bind('<Shift-Tab>', 'prompt-item-focus prev', mode='prompt')
...
config.bind('gT', 'config-cycle tabs.show always never')

## Colorscheme (leave at the end of config.py)
