...
function vim#togglequickfixlist()
...
function vim#togglelocationlist()
  try
...
" clear registers
function vim#clearregisters(chars)
...
function vim#toggleterm(vsplit)
  if !exists('t:termbuf')
    let t:termbuf = 0
  endif
  if !exists('t:termwin')
