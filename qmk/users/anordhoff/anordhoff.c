...
const key_override_t colemak_backspace_key_override = ko_make_with_layers(MOD_MASK_SHIFT, KC_BSPC, KC_DEL, 1 << _COLEMAK);
const key_override_t game_comma_key_override = ko_make_with_layers(MOD_MASK_SHIFT, KC_COMM, KC_DOT, 1 << _GAME);
const key_override_t game_backspace_key_override = ko_make_with_layers(MOD_MASK_SHIFT, KC_BSPC, KC_DEL, 1 << _GAME);

// layer_r overrides
const key_override_t layer_r_backspace_key_override = ko_make_with_layers(MOD_MASK_SHIFT, KC_BSPC, KC_DEL, 1 << _LAYER_R);
...
const key_override_t layer_s_backspace_key_override = ko_make_with_layers(MOD_MASK_SHIFT, KC_BSPC, KC_DEL, 1 << _LAYER_S);
...
const key_override_t layer_t_backspace_key_override = ko_make_with_layers(MOD_MASK_SHIFT, KC_BSPC, KC_DEL, 1 << _LAYER_T);
...
const key_override_t layer_n_backspace_key_override = ko_make_with_layers(MOD_MASK_SHIFT, KC_BSPC, KC_DEL, 1 << _LAYER_N);

// layer_e overrides
const key_override_t layer_e_backspace_key_override = ko_make_with_layers(MOD_MASK_SHIFT, KC_BSPC, KC_DEL, 1 << _LAYER_E);

// layer_i overrides
const key_override_t layer_i_backspace_key_override = ko_make_with_layers(MOD_MASK_SHIFT, KC_BSPC, KC_DEL, 1 << _LAYER_I);
